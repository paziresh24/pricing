...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: OiZqCFXnVtk_/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: eXdB-XBoNLdg/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__pW6GD)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__agkpF)}
              />
            </React.Fragment>
          ),
          value: args.children
