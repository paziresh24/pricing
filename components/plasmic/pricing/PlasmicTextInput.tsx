...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: ZdzGQGZE4mJ7/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__jlkey)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__v5BmL)}
              role={"img"}
            />
          ),
